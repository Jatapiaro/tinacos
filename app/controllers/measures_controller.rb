class MeasuresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @measure.save
        format.html { redirect_to @measure.container, notice: 'Measure was successfully created.' }
        format.json { render :show, status: :created, location: @measure.container }
      else
  ...
  private
    ...
    def measure_params
      params.require(:measure).permit(:container_id, :height, :water_quantity)
    end
end
