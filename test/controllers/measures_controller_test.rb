...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { container_id: @measure.container_id, height: @measure.height, water_quantity: @measure.water_quantity } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { container_id: @measure.container_id, height: @measure.height, water_quantity: @measure.water_quantity } }
