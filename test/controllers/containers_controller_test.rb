...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post containers_url, params: { container: { height: @container.height, name: @container.name, radius: @container.radius, volume: @container.volume } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { height: @container.height, name: @container.name, radius: @container.radius, volume: @container.volume } }
